...
using Playarr.RuntimePatches;

namespace Playarr.Console
{
    public static class ConsoleApp
    {
        private static readonly Logger Logger = PlayarrLogger.GetLogger(typeof(ConsoleApp));
        ...
        public static void Main(string[] args)
        {
            ...
            catch (PlayarrStartupException ex)
            {
            ...
            catch (SocketException ex)
            {
                System.Console.WriteLine("");
                System.Console.WriteLine("");
                Logger.Fatal(ex.Message + ". This can happen if another instance of Playarr is already running another application is using the same port (default: 9797) or the user has insufficient permissions");
