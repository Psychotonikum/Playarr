...
namespace Playarr.Core.Validation
{
    public static class RuleBuilderExtensions
    {
        ...
        public static IRuleBuilderOptions<T, string> ValidUrlBase<T>(this IRuleBuilder<T, string> ruleBuilder, string example = "/playarr")
        {
        ...
        {
            return ruleBuilder.WithState(v => PlayarrValidationState.Warning);
        }

        public static IRuleBuilderOptions<T, string> StartsOrEndsWithPlayarr<T>(this IRuleBuilder<T, string> ruleBuilder)
        {
            ruleBuilder.SetValidator(new NotEmptyValidator(null));
            return ruleBuilder.SetValidator(new RegularExpressionValidator("^Playarr|Playarr$")).WithMessage("Must start or end with Playarr");
        }
    }
}
