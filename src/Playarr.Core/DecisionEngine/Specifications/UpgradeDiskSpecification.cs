...
namespace Playarr.Core.DecisionEngine.Specifications
{
    public class UpgradeDiskSpecification : IDownloadDecisionEngineSpecification
    {
        ...
        public virtual DownloadSpecDecision IsSatisfiedBy(RemoteEpisode subject, ReleaseDecisionInformation information)
        {
            ...
            {
                var totalEpisodesInPack = subject.Roms.Count;
                ...
                var missingEpisodesCount = subject.Roms.Count(c => c.EpisodeFileId == 0);
                ...
                var existingRomFiles = subject.Roms.Where(c => c.EpisodeFileId != 0)
                ...
                _logger.Debug("Total upgradable roms: {0} out of {1}. Platform import setting: {2}, Threshold: {3}%", upgradedCount, totalEpisodesInPack, seasonPackUpgrade, seasonPackUpgradeThreshold);
                ...
                return DownloadSpecDecision.Reject(DownloadRejectionReason.DiskNotUpgrade, $"Platform pack does not meet the upgrade criteria. Upgradable: {upgradedCount}/{totalEpisodesInPack} ({upgradablePercentage:0.##}%), Mode: {seasonPackUpgrade}, Threshold: {seasonPackUpgradeThreshold}%");
            }
