...
namespace Playarr.Core.ImportLists
{
    public class ImportListFetchResult
    {
        ...
        {
            Game = new List<ImportListItemInfo>();
        }

        public ImportListFetchResult(IEnumerable<ImportListItemInfo> game, bool anyFailure)
        {
            Game = game.ToList();
            AnyFailure = anyFailure;
        }

        public List<ImportListItemInfo> Game { get; set; }
