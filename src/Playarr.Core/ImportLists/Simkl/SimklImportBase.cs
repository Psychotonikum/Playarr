...
namespace Playarr.Core.ImportLists.Simkl
{
    ...
    where TSettings : SimklSettingsBase<TSettings>, new()
    {
        ...
        public const string RedirectUri = "https://auth.servarr.com/v1/simkl_playarr/auth";
        public const string RenewUri = "https://auth.servarr.com/v1/simkl_playarr/renew";
        ...
        public override ImportListFetchResult Fetch()
        {
            ...
            {
                // mark failure to avoid deleting game due to emptyness
