...
namespace Playarr.Core.ImportLists.MyAnimeList
{
    public class MyAnimeListImport : HttpImportListBase<MyAnimeListSettings>
    {
        ...
        // This constructor the first thing that is called when playarr creates a button
        public MyAnimeListImport(IImportListRepository netImportRepository, IHttpClient httpClient, IImportListStatusService importListStatusService, IConfigService configService, IParsingService parsingService, ILocalizationService localizationService, IPlayarrCloudRequestBuilder requestBuilder, Logger logger)
        ...
        // The whole process is handled through Playarr's services.
