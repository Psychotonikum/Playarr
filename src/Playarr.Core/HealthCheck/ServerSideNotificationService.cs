...
namespace Playarr.Core.HealthCheck
{
    public class ServerSideNotificationService : HealthCheckBase
    {
        ...
        private readonly IPlayarrCloudRequestBuilder _cloudRequestBuilder;
        private readonly IConfigFileProvider _configFileProvider;
        private readonly Logger _logger;

        public ServerSideNotificationService(IHttpClient client, IPlayarrCloudRequestBuilder cloudRequestBuilder, IConfigFileProvider configFileProvider, ILocalizationService localizationService, Logger logger)
