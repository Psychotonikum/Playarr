...
namespace Playarr.Core.Update
{
    public class InstallUpdateService : IExecute<ApplicationUpdateCommand>, IExecute<ApplicationUpdateCheckCommand>, IHandle<ApplicationStartingEvent>
    {
        ...
        private bool InstallUpdate(UpdatePackage updatePackage)
        {
            ...
            {
                _logger.Warn("Temporary location '{0}' has less than 1 GB free space, Playarr may not be able to update itself.", tempFolder);
            }
            ...
            _logger.ProgressInfo("Playarr will restart shortly.");
        ...
        private void InstallUpdateWithScript(string updateSandboxFolder)
        {
            ...
            _logger.Info("Removing Playarr.Update");
        ...
        private void EnsureAppDataSafety()
        {
            ...
            {
                throw new UpdateFailedException("Your Playarr configuration '{0}' is being stored in application folder '{1}' which will cause data lost during the upgrade. Please remove any symlinks or redirects before trying again.", _appFolderInfo.AppDataFolder, _appFolderInfo.StartUpFolder);
            }
        }
        ...
        public void Execute(ApplicationUpdateCommand message)
        {
            ...
            if (latestAvailable != null)
            {
                try
                {
                    ...
                    _logger.ProgressDebug("Restarting Playarr to apply updates");
                }
