...
namespace Playarr.Core.Download.Clients.Deluge
{
    ...
    public class DelugeProxy : IDelugeProxy
    {
        ...
        public DelugeTorrent[] GetTorrents(DelugeSettings settings)
        {
            ...
            // TODO: get_torrents_status returns the files as well, which starts to cause deluge timeouts when you get enough platform packs.
        ...
        {
            var response = ProcessRequest<DelugeLabel>(settings, "label.get_options", settings.GameCategory);
