...
namespace Playarr.Core.Download.Clients.FreeboxDownload
{
    public class TorrentFreeboxDownload : TorrentClientBase<FreeboxDownloadSettings>
    {
        ...
        protected override string AddFromMagnetLink(RemoteRom remoteRom, string hash, string magnetLink)
        {
            return _proxy.AddTaskFromUrl(magnetLink,
                                         ...
                                         ToBePaused(),
                                         ToBeQueuedFirst(remoteRom),
                                         GetSeedRatio(remoteRom),
                                         Settings);
        }
        ...
        private double? GetSeedRatio(RemoteRom remoteRom)
        {
            ...
            return remoteRom.SeedConfiguration.Ratio.Value * 100;
        }
    }
}
