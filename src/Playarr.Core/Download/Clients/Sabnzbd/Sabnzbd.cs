...
namespace Playarr.Core.Download.Clients.Sabnzbd
{
    public class Sabnzbd : UsenetClientBase<SabnzbdSettings>
    {
        ...
        protected override string AddFromNzbFile(RemoteEpisode remoteRom, string filename, byte[] fileContent)
        {
            ...
            {
                throw new DownloadClientRejectedReleaseException(remoteRom.Release, "SABnzbd rejected the NZB for an unknown reason");
            }
        ...
        public override DownloadClientInfo GetStatus()
        {
            ...
            if (category != null)
            {
                if ((config.Misc.enable_tv_sorting && ContainsCategory(config.Misc.tv_categories, Settings.GameCategory)) || config.Sorters.Any(s => s.is_active && ContainsCategory(s.sort_cats, Settings.GameCategory)))
                {
                    status.SortingMode = "TV";
                }
                else if (config.Misc.enable_movie_sorting && ContainsCategory(config.Misc.movie_categories, Settings.GameCategory))
                {
        ...
        private ValidationFailure TestConnectionAndVersion()
        {
            try
            {
                ...
                {
                    return new PlayarrValidationFailure("Version", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationDevelopVersion"))
                    {
                        IsWarning = true,
        ...
        private ValidationFailure TestGlobalConfig()
        {
            ...
            {
                return new PlayarrValidationFailure("", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationCheckBeforeDownload"))
                {
        ...
        private ValidationFailure TestCategory()
        {
            ...
            if (category != null)
            {
                ...
                {
                    return new PlayarrValidationFailure("GameCategory", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationEnableJobFolders"))
                    {
            ...
            else
            {
                ...
                {
                    return new PlayarrValidationFailure("GameCategory", _localizationService.GetLocalizedString("DownloadClientValidationCategoryMissing"))
                    {
                        InfoLink = _proxy.GetBaseUrl(Settings, "config/categories/"),
            ...
            {
                return new PlayarrValidationFailure("GameCategory", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationEnableDisableGameSorting"))
                {
            ...
            if (config.Misc.enable_movie_sorting && ContainsCategory(config.Misc.movie_categories, Settings.GameCategory))
            {
                return new PlayarrValidationFailure("GameCategory", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationEnableDisableMovieSorting"))
                {
                    InfoLink = _proxy.GetBaseUrl(Settings, "config/sorting/"),
            ...
            {
                return new PlayarrValidationFailure("GameCategory", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationEnableDisableDateSorting"))
                {
                    InfoLink = _proxy.GetBaseUrl(Settings, "config/sorting/"),
