...
{
    [Migration(210)]
    public class add_monitored_seasons_filter : PlayarrMigrationBase
    {
        ...
        private void ChangeHasUnmonitoredSeason(IDbConnection conn, IDbTransaction tran)
        {
            ...
            using (var getUnmonitoredSeasonFilter = conn.CreateCommand())
            {
                ...
                getUnmonitoredSeasonFilter.CommandText = "SELECT \"Id\", \"Filters\" FROM \"CustomFilters\" WHERE \"Type\" = 'game'";
