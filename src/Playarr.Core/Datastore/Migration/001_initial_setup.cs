...
{
    [Migration(1)]
    public class InitialSetup : PlayarrMigrationBase
    {
        protected override void MainDbUpgrade()
        {
            ...
            Create.TableForModel("Series")
                ...
                .WithColumn("MobyGamesId").AsInt32().Unique()
                ...
                .WithColumn("PlatformFolder").AsBoolean()
            ...
            Create.TableForModel("Platforms")
            ...
            Create.TableForModel("NamingConfig")
                  ...
                  .WithColumn("IncludeGameTitle").AsBoolean()
                  .WithColumn("MultiEpisodeStyle").AsInt32()
                  .WithColumn("IncludeRomTitle").AsBoolean()
                  .WithColumn("IncludeQuality").AsBoolean()
                  .WithColumn("ReplaceSpaces").AsBoolean()
                  .WithColumn("PlatformFolderFormat").AsString();
        }
