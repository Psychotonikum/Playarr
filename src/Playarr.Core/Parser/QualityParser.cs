...
namespace Playarr.Core.Parser
{
    ...
    {
        private static readonly Logger Logger = PlayarrLogger.GetLogger(typeof(QualityParser));
        ...
        private static QualityModel ParseQualityModifiers(string name, string normalizedName)
        {
            ...
            // TODO: Only treat it as a real if it comes AFTER the platform/rom number
