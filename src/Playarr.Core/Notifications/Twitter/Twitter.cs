...
namespace Playarr.Core.Notifications.Twitter
{
    public class Twitter : NotificationBase<TwitterSettings>
    {
        ...
        {
            _twitterService.SendNotification($"Rom Deleted: {deleteMessage.Message}", Settings);
        }

        public override void OnSeriesAdd(SeriesAddMessage message)
        {
            _twitterService.SendNotification($"Game Added: {message.Message}", Settings);
        }

        public override void OnSeriesDelete(SeriesDeleteMessage deleteMessage)
        {
            _twitterService.SendNotification($"Game Deleted: {deleteMessage.Message}", Settings);
        }
