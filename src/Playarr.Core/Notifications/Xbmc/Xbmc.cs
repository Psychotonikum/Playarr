...
namespace Playarr.Core.Notifications.Xbmc
{
    public class Xbmc : NotificationBase<XbmcSettings>
    {
        ...
        {
            const string header = "Playarr - Grabbed";
        ...
        {
            const string header = "Playarr - Downloaded";
        ...
        {
            const string header = "Playarr - Imported";
        ...
        {
            const string header = "Playarr - Deleted";
        ...
        {
            const string header = "Playarr - Added";
