...
using Playarr.Core.Notifications.Xbmc.Model;
...
namespace Playarr.Core.Notifications.Xbmc
{
    ...
    public class XbmcJsonApiProxy : IXbmcJsonApiProxy
    {
        ...
        {
            ProcessRequest(settings, "GUI.ShowNotification", title, message, "https://raw.github.com/Playarr/Playarr/develop/Logo/64.png", settings.DisplayTime * 1000);
        }
