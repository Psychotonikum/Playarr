...
namespace Playarr.Core.Notifications.Join
{
    ...
    public class JoinProxy : IJoinProxy
    {
        ...
        public ValidationFailure Test(JoinSettings settings)
        {
            ...
            const string body = "This is a test message from Playarr.";
        ...
        private void SendNotification(string title, string message, HttpMethod method, JoinSettings settings)
        {
            ...
            var request = requestBuilder.AddQueryParam("apikey", settings.ApiKey)
                          ...
                          .AddQueryParam("icon", "https://cdn.rawgit.com/Playarr/Playarr/main/Logo/256.png") // Use the Playarr logo.
                          .AddQueryParam("smallicon", "https://cdn.rawgit.com/Playarr/Playarr/main/Logo/96-Outline-White.png") // 96x96px with outline at 88x88px on a transparent background.
