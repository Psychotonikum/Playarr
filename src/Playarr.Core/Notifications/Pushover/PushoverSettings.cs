...
namespace Playarr.Core.Notifications.Pushover
{
    ...
    public class PushoverSettings : NotificationSettingsBase<PushoverSettings>
    {
        ...
        [FieldDefinition(0, Label = "ApiKey", Privacy = PrivacyLevel.ApiKey, HelpLink = "https://pushover.net/apps/clone/playarr")]
