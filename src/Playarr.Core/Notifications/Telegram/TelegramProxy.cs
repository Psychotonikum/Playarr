...
namespace Playarr.Core.Notifications.Telegram
{
    ...
    public class TelegramProxy : ITelegramProxy
    {
        ...
        public ValidationFailure Test(TelegramSettings settings)
        {
            try
            {
                const string brandedTitle = "Playarr - Test Notification";
                const string title = "Test Notification";
                const string body = "This is a test message from Playarr";

                var links = new List<NotificationMetadataLink>
                    {
                        new NotificationMetadataLink(null, "Playarr.tv", "https://playarr.tv")
                    };
