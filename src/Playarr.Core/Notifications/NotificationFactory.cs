...
namespace Playarr.Core.Notifications
{
    public interface INotificationFactory : IProviderFactory<INotification, NotificationDefinition>
    {
        ...
        List<INotification> OnRomFileDeleteEnabled(bool filterBlockedNotifications = true);
        List<INotification> OnRomFileDeleteForUpgradeEnabled(bool filterBlockedNotifications = true);
    ...
    public class NotificationFactory : ProviderFactory<INotification, NotificationDefinition>, INotificationFactory
    {
        ...
        public List<INotification> OnRomFileDeleteEnabled(bool filterBlockedNotifications = true)
        {
            if (filterBlockedNotifications)
            {
                return FilterBlockedNotifications(GetAvailableProviders().Where(n => ((NotificationDefinition)n.Definition).OnRomFileDelete)).ToList();
            }

            return GetAvailableProviders().Where(n => ((NotificationDefinition)n.Definition).OnRomFileDelete).ToList();
        }

        public List<INotification> OnRomFileDeleteForUpgradeEnabled(bool filterBlockedNotifications = true)
        {
            if (filterBlockedNotifications)
            {
                return FilterBlockedNotifications(GetAvailableProviders().Where(n => ((NotificationDefinition)n.Definition).OnRomFileDeleteForUpgrade)).ToList();
            }

            return GetAvailableProviders().Where(n => ((NotificationDefinition)n.Definition).OnRomFileDeleteForUpgrade).ToList();
        }
        ...
        public override void SetProviderCharacteristics(INotification provider, NotificationDefinition definition)
        {
            ...
            definition.SupportsOnRomFileDelete = provider.SupportsOnRomFileDelete;
            definition.SupportsOnRomFileDeleteForUpgrade = provider.SupportsOnRomFileDeleteForUpgrade;
