...
namespace Playarr.Http.ErrorManagement
{
    public class PlayarrErrorPipeline
    {
        private readonly Logger _logger;

        public PlayarrErrorPipeline(Logger logger)
        {
            _logger = logger;
        }
        ...
        public async Task HandleException(HttpContext context)
        {
            ...
            else if (exception is PlayarrClientException clientException)
            {
