...
namespace Playarr.Update.Test
{
   ...
   public class UpdateProviderStartFixture : TestBase
    {
        private const string UPDATE_FOLDER = @"C:\Temp\playarr_update\playarr\";
        private const string BACKUP_FOLDER = @"C:\Temp\playarr_update\playarr_backup\";
        private const string TARGET_FOLDER = @"C:\Playarr\";
        ...
        [Test]
        public void should_stop_playarr_service_if_installed_and_running()
        {
        ...
        [Test]
        public void should_not_stop_playarr_service_if_installed_but_not_running()
        {
            WithInstalledService();
        ...
        [Test]
        public void should_not_stop_playarr_service_if_service_isnt_installed()
        {
        ...
        [Test]
        public void should_kill_playarr_process_if_running()
        {
            var processes = Builder<ProcessInfo>.CreateListOfSize(2).Build().ToList();

            Mocker.GetMock<IProcessProvider>()
                .Setup(c => c.GetProcessByName(ProcessProvider.PlayarrProcessName))
                .Returns(processes);
            ...
            Mocker.GetMock<IProcessProvider>().Verify(c => c.KillAll(ProcessProvider.PlayarrProcessName), Times.Once());
        }

        [Test]
        public void should_not_kill_playarr_process_not_running()
        {
            Mocker.GetMock<IProcessProvider>()
                .Setup(c => c.GetProcessByName(ProcessProvider.PlayarrProcessName))
        ...
        private void VerifyProcessRestart()
        {
            ...
            Mocker.GetMock<IProcessProvider>()
                .Verify(c => c.Start(TARGET_FOLDER + "Playarr.exe"), Times.Once());
        }
