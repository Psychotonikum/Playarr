...
namespace Playarr.Test.Common
{
    public abstract class LoggingTest
    {
        ...
        protected static readonly Logger TestLogger = PlayarrLogger.GetLogger("TestLogger");
        ...
        protected static void InitLogging()
        {
            ...
            lock (_initLock)
            {
                if (LogManager.Configuration == null || LogManager.Configuration.AllTargets.None(c => c is ExceptionVerification))
                {
                    ...
                    Enum.TryParse<TestLogOutput>(Environment.GetEnvironmentVariable("PLAYARR_TESTS_LOG_OUTPUT"), out var logOutput);
