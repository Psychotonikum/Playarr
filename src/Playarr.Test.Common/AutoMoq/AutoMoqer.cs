...
using DryIoc;
using Moq;
using Playarr.Common.Composition;
using Playarr.Common.EnvironmentInfo;

namespace Playarr.Test.Common.AutoMoq
{
    [DebuggerStepThrough]
    public class AutoMoqer
    {
        ...
        private void SetupAutoMoqer(IContainer container)
        {
            ...
            AssemblyLoader.RegisterNativeResolver(new[] { "System.Data.SQLite", "Playarr.Core" });
        }
        ...
        {
            var assemblyName = "Playarr.Windows";

            if (OsInfo.IsNotWindows)
            {
                assemblyName = "Playarr.Mono";
            }
