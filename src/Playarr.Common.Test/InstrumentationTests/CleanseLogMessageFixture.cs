...
namespace Playarr.Common.Test.InstrumentationTests
{
    [TestFixture]
    public class CleanseLogMessageFixture
    {
        ...
        [TestCase(@"https://rss.omgwtfnzbs.org/rss-search.php?catid=19,20&user=playarr&api=mySecret&eng=1")]
        ...
        // Plex
        [TestCase(@" http://localhost:32400/library/metadata/12345/refresh?X-Plex-Client-Identifier=1234530f-422f-4aac-b6b3-01233210aaaa&X-Plex-Product=Playarr&X-Plex-Platform=Windows&X-Plex-Platform-Version=7&X-Plex-Device-Name=Playarr&X-Plex-Version=3.0.3.833&X-Plex-Token=mySecret")]

        // Internal
        [TestCase(@"OutputPath=/home/mySecret/Downloads")]
        [TestCase(@"OutputPath=/Users/mySecret/Downloads")]
        [TestCase("Hardlinking rom file: /home/mySecret/Downloads to /media/abc.mkv")]
        [TestCase("Hardlinking rom file: /Users/mySecret/Downloads to /media/abc.mkv")]
        ...
        [TestCase("/playarr/signalr/messages/negotiate?access_token=1234530f422f4aacb6b301233210aaaa&negotiateVersion=1")]
        [TestCase(@"[Info] MigrationController: *** Migrating Database=playarr-main;Host=postgres14;Username=mySecret;Password=mySecret;Port=5432;Enlist=False ***")]
        [TestCase(@"[Info] MigrationController: *** Migrating Database=playarr-main;Host=postgres14;Username=mySecret;Password=mySecret;Port=5432;token=mySecret;Enlist=False&username=mySecret;mypassword=mySecret;mypass=shouldkeep1;test_token=mySecret;password=123%@%_@!#^#@;use_password=mySecret;get_token=shouldkeep2;usetoken=shouldkeep3;passwrd=mySecret;")]
        ...
        // Webhooks - Notifiarr
        [TestCase(@"https://xxx.yyy/api/v1/notification/playarr/9pr04sg6-0123-3210-imav-eql2tyu8xyui")]
