...
namespace Playarr.Common.Test
{
    ...
    public class PathExtensionFixture : TestBase
    {
        ...
        private IAppFolderInfo GetIAppDirectoryInfo()
        {
            ...
            fakeEnvironment.SetupGet(c => c.AppDataFolder).Returns(@"C:\Playarr\".AsOsAgnostic());
        ...
        {
            GetIAppDirectoryInfo().GetAppDataPath().Should().BeEquivalentTo(@"C:\Playarr\".AsOsAgnostic());
        }

        [Test]
        public void Config_path_test()
        {
            GetIAppDirectoryInfo().GetConfigPath().Should().BeEquivalentTo(@"C:\Playarr\Config.xml".AsOsAgnostic());
        }

        [Test]
        public void Sandbox()
        {
            GetIAppDirectoryInfo().GetUpdateSandboxFolder().Should().BeEquivalentTo(@"C:\Temp\playarr_update\".AsOsAgnostic());
        }

        [Test]
        public void GetUpdatePackageFolder()
        {
            GetIAppDirectoryInfo().GetUpdatePackageFolder().Should().BeEquivalentTo(@"C:\Temp\playarr_update\Playarr\".AsOsAgnostic());
        }

        [Test]
        public void GetUpdateClientFolder()
        {
            GetIAppDirectoryInfo().GetUpdateClientFolder().Should().BeEquivalentTo(@"C:\Temp\playarr_update\Playarr\Playarr.Update\".AsOsAgnostic());
        }

        [Test]
        public void GetUpdateClientExePath()
        {
            GetIAppDirectoryInfo().GetUpdateClientExePath().Should().BeEquivalentTo(@"C:\Temp\playarr_update\Playarr.Update".AsOsAgnostic().ProcessNameToExe());
        }

        [Test]
        public void GetUpdateLogFolder()
        {
            GetIAppDirectoryInfo().GetUpdateLogFolder().Should().BeEquivalentTo(@"C:\Playarr\UpdateLogs\".AsOsAgnostic());
        }
        ...
        [TestCase(@"C:\Test\", @"C:\Test\Game Title", "Game Title")]
        [TestCase(@"C:\Test\", @"C:\Test\Collection\Game Title", @"Collection\Game Title")]
        [TestCase(@"C:\Test\mydir\", @"C:\Test\mydir\Collection\Game Title", @"Collection\Game Title")]
        [TestCase(@"\\server\share", @"\\server\share\Game Title", "Game Title")]
        [TestCase(@"\\server\share\mydir\", @"\\server\share\mydir\/Collection\Game Title", @"Collection\Game Title")]
        ...
        [TestCase(@"/test", "/test/Game Title", "Game Title")]
        [TestCase(@"/test/", "/test/Collection/Game Title", "Collection/Game Title")]
        [TestCase(@"/test/mydir", "/test/mydir/Game Title", "Game Title")]
        [TestCase(@"/test/mydir/", "/test/mydir/Collection/Game Title", "Collection/Game Title")]
        [TestCase(@"/test/mydir/", @"/test/mydir/\Collection/Game Title", "Collection/Game Title")]
