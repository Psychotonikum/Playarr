...
using Playarr.Automation.Test.PageModel;
...
namespace Playarr.Automation.Test
{
    ...
    public abstract class AutomationTest
    {
        ...
        public void SmokeTestSetup()
        {
            ...
            _runner = new PlayarrRunner(LogManager.GetCurrentClassLogger(), null);
            _runner.KillAll();
            _runner.Start(true);

            driver.Url = "http://localhost:9797";

            var page = new PageBase(driver);
            page.WaitForNoSpinner();

            driver.ExecuteScript("window.Playarr.NameViews = true;");
