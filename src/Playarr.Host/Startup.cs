...
using Playarr.Host.AccessControl;
using Playarr.Http.Authentication;
using Playarr.SignalR;
using Playarr.Api.V3.System;
using Playarr.Api.V5.Game;
using Playarr.Http;
using Playarr.Http.ClientSchema;
using Playarr.Http.ErrorManagement;
using Playarr.Http.Frontend;
using Playarr.Http.Middleware;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddLogging(b =>
            {
                ...
                b.AddFilter("Playarr.Http.Authentication.ApiKeyAuthenticationHandler", LogLevel.Information);
            ...
            .AddApplicationPart(typeof(GameLookupController).Assembly)
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v3", new OpenApiInfo
                {
                    Version = "3.0.0",
                    Title = "Playarr",
                    Description = "Playarr API docs - The v3 API docs apply to both v3 and v4 versions of Playarr. Some functionality may only be available in v4 of the Playarr application.",
                    License = new OpenApiLicense
                    {
                        Name = "GPL-3.0",
                        Url = new Uri("https://github.com/Playarr/Playarr/blob/develop/LICENSE")
                    }
                });
                ...
                c.SwaggerDoc("v5", new OpenApiInfo
                {
                    Version = "5.0.0",
                    Title = "Playarr",
                    Description = "Playarr API docs - The v5 API docs apply to Playarr v5 only.",
                    License = new OpenApiLicense
                    {
                        Name = "GPL-3.0",
                        Url = new Uri("https://github.com/Playarr/Playarr/blob/develop/LICENSE")
                ...
                c.AddServer(new OpenApiServer
                {
                    ...
                    Variables = new Dictionary<string, OpenApiServerVariable>
                    {
                        ...
                        { "hostpath", new OpenApiServerVariable { Default = "localhost:9797" } }
                    }
                });
        ...
        public void Configure(IApplicationBuilder app,
                              ...
                              PlayarrErrorPipeline errorHandler)
        {
