...
public class RomController : RomControllerWithSignalR
{
    ...
    public List<RomResource> GetEpisodes(int? gameId, int? platformNumber, [FromQuery]List<int> romIds, int? romFileId, [FromQuery] EpisodeSubresource[]? includeSubresources = null)
    {
