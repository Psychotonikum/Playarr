    ...
    public class add_custom_formatsFixture : MigrationTest<add_custom_formats>
    {
        ...
        public void should_migrate_naming_configs()
        {
            var db = WithMigrationTestDb(c =>
            {
                ...
                {
                    MultiEpisodeStyle = 0,
                    StandardEpisodeFormat = "{Game Title} - S{platform:00}E{rom:00} - {Rom Title} {Preferred Words } {Quality Full}",
                    DailyEpisodeFormat = "{Game Title} - {Air-Date} - {Rom Title} {Preferred.Words } {Quality Full}",
                    AnimeEpisodeFormat = "{Game Title} - S{platform:00}E{rom:00} - {Preferred_Words} {Quality Full}",
                });
            });
            ...
            customFormats.Should().HaveCount(1);
            customFormats.First().StandardEpisodeFormat.Should().Be("{Game Title} - S{platform:00}E{rom:00} - {Rom Title} {Custom Formats } {Quality Full}");
            customFormats.First().DailyEpisodeFormat.Should().Be("{Game Title} - {Air-Date} - {Rom Title} {Custom.Formats } {Quality Full}");
            customFormats.First().AnimeEpisodeFormat.Should().Be("{Game Title} - S{platform:00}E{rom:00} - {Custom_Formats} {Quality Full}");
        }
