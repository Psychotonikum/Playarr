...
namespace Playarr.Core.Test.OrganizerTests.FileNameBuilderTests
{
    ...
    public class TruncatedRomTitlesFixture : CoreTest<FileNameBuilder>
    {
        ...
        public void should_truncate_with_extension()
        {
            ...
            result.Should().Be("The Fantastic Life of Mr. Sisko - S02E18 - This title has to be 197 characters in length, combined with the game title, quality and rom number it becomes 254ish and the extension puts it above the 255 limit and triggers the trunc... Bluray-1080p.mkv");
        }
        ...
        public void should_truncate_with_ellipsis_between_first_and_last_episode_titles()
        {
            ...
            result.Length.Should().BeLessOrEqualTo(255);
            result.Should().Be("Game Title - S01E01-02-03-04-05-06-07 - Rom Title 1...A Really Really Really Really Long Rom Title HDTV-720p");
        }
        ...
        public void should_truncate_first_episode_title_with_ellipsis_if_only_partially_fits()
        {
            ...
            result.Length.Should().BeLessOrEqualTo(255);
            result.Should().Be("Lorem ipsum dolor sit amet, consectetur adipiscing elit Maecenas et magna sem Morbi vitae volutpat quam, id porta arcu Orci varius natoque penatibus et magnis dis parturient montes nascetur ridiculus musu Cras vestibulum - S01E01 - Rom Ti... HDTV-720p");
        }
        ...
        public void should_truncate_titles_measuring_series_title_bytes()
        {
            ...
            result.Should().Be("Lor\u00E9m ipsum dolor sit amet, consectetur adipiscing elit Maecenas et magna sem Morbi vitae volutpat quam, id porta arcu Orci varius natoque penatibus et magnis dis parturient montes nascetur ridiculus musu Cras vestibulum - S01E01 - Rom T... HDTV-720p");
        }
        ...
        public void should_truncate_titles_measuring_episode_title_bytes_middle()
        {
            ...
            result.Should().Be("Lorem ipsum dolor sit amet, consectetur adipiscing elit Maecenas et magna sem Morbi vitae volutpat quam, id porta arcu Orci varius natoque penatibus et magnis dis parturient montes nascetur ridiculus musu Cras vestibulum - S01E01 - Rom T... HDTV-720p");
        }
    }
}
