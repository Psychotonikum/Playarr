...
namespace Playarr.Core.Test.OrganizerTests.FileNameBuilderTests
{
    ...
    public class CustomFormatsFixture : CoreTest<FileNameBuilder>
    {
        ...
        public void should_replace_custom_formats(string format, string expected)
        {
            ...
            Subject.BuildFileName(new List<Rom> { _episode1 }, _series, _romFile, customFormats: _customFormats)
                   .Should().Be(expected);
        }
        ...
        public void should_replace_custom_formats_with_no_custom_formats(string format, string expected)
        {
            ...
            Subject.BuildFileName(new List<Rom> { _episode1 }, _series, _romFile, customFormats: new List<CustomFormat>())
                   .Should().Be(expected);
        }
