...
namespace Playarr.Core.Test.OrganizerTests.FileNameBuilderTests
{
    ...
    public class CleanTitleWithoutYearFixture : CoreTest<FileNameBuilder>
    {
        ...
        [TestCase("The Game Title's (2016)", 2016, "The Game Titles")]
        [TestCase("The Game Title's", 2016, "The Game Title's")]
        public void should_get_expected_title_back(string title, int year, string expected)
        {
            _series.Title = title;
            _series.Year = year;
            _namingConfig.StandardEpisodeFormat = "{Game CleanTitleWithoutYear}";
