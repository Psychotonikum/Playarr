...
namespace Playarr.Core.Test.Download.DownloadClientTests.DownloadStationTests
{
    ...
    public class UsenetDownloadStationFixture : DownloadClientFixtureBase<UsenetDownloadStation>
    {
        ...
        protected string _category = "playarr";
        protected string _gameDirectory = @"video/Game";
        ...
        public void Setup()
        {
            _remoteRom = CreateRemoteEpisode();
            ...
            _queued = new DownloadStationTask()
            {
                ...
                Additional = new DownloadStationTaskAdditional
                {
                    Detail = new Dictionary<string, string>
                    {
                        ...
                        { "uri", FileNameBuilder.CleanFileName(_remoteRom.Release.Title) + ".nzb" }
                    },
        ...
        {
            _settings.GameCategory = _category;
        }

        protected void GivenGameDirectory()
        {
            _settings.GameDirectory = _gameDirectory;
        }
        ...
        public async Task Download_with_GameDirectory_should_force_directory()
        {
            ...
            Mocker.GetMock<IDownloadStationTaskProxy>()
                  .Verify(v => v.AddTaskFromData(It.IsAny<byte[]>(), It.IsAny<string>(), _gameDirectory, It.IsAny<DownloadStationSettings>()), Times.Once());
        }
        ...
        {
            _settings.GameDirectory = @"/shared/folder/sub";
        ...
        public void Download_should_throw_and_not_add_task_if_cannot_get_serial_number()
        {
            ...
            Assert.ThrowsAsync(Is.InstanceOf<Exception>(), async () => await Subject.Download(remoteRom, CreateIndexer()));
