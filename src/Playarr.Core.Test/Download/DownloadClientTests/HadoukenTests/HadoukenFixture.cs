...
using Playarr.Core.Download.Clients.Hadouken;
using Playarr.Core.Download.Clients.Hadouken.Models;
using Playarr.Core.MediaFiles.TorrentInfo;
using Playarr.Test.Common;

namespace Playarr.Core.Test.Download.DownloadClientTests.HadoukenTests
{
    [TestFixture]
    public class HadoukenFixture : DownloadClientFixtureBase<Hadouken>
    {
        ...
        public async Task Download_from_magnet_link_should_return_hash_uppercase()
        {
            ...
            remoteRom.Release.DownloadUrl = "magnet:?xt=urn:btih:a45129e59d8750f9da982f53552b1e4f0457ee9f";
