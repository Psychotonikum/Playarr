...
using Playarr.Core.Download.Clients.Blackhole;
...
namespace Playarr.Core.Test.Download.DownloadClientTests.Blackhole
{
    [TestFixture]
    public class TorrentBlackholeFixture : DownloadClientFixtureBase<TorrentBlackhole>
    {
        ...
        protected override RemoteEpisode CreateRemoteEpisode()
        {
            ...
            torrentInfo.Title = remoteRom.Release.Title;
            torrentInfo.DownloadUrl = remoteRom.Release.DownloadUrl;
            torrentInfo.DownloadProtocol = remoteRom.Release.DownloadProtocol;
            torrentInfo.MagnetUrl = "magnet:?xt=urn:btih:755248817d32b00cc853e633ecdc48e4c21bff15&dn=Game.S05E10.PROPER.HDTV.x264-DEFiNE%5Brartv%5D&tr=http%3A%2F%2Ftracker.trackerfix.com%3A80%2Fannounce&tr=udp%3A%2F%2F9.rarbg.me%3A2710&tr=udp%3A%2F%2F9.rarbg.to%3A2710";

            remoteRom.Release = torrentInfo;
        ...
        {
            var remoteRom = CreateRemoteEpisode();

            await Subject.Download(remoteRom, CreateIndexer());
        ...
        public async Task Download_should_save_magnet_if_enabled()
        {
            ...
            var remoteRom = CreateRemoteEpisode();
            remoteRom.Release.DownloadUrl = null;
        ...
        public void Download_should_not_save_magnet_if_disabled()
        {
            ...
            Assert.ThrowsAsync<ReleaseDownloadException>(async () => await Subject.Download(remoteRom, CreateIndexer()));
        ...
        public async Task Download_should_replace_illegal_characters_in_title()
        {
            ...
            var remoteRom = CreateRemoteEpisode();
            remoteRom.Release.Title = illegalTitle;
        ...
        public async Task should_return_null_hash()
        {
            ...
            var result = await Subject.Download(remoteRom, CreateIndexer());
