...
using Playarr.Core.Download.Clients.QBittorrent;
using Playarr.Core.Exceptions;
using Playarr.Core.MediaFiles.TorrentInfo;
using Playarr.Test.Common;

namespace Playarr.Core.Test.Download.DownloadClientTests.QBittorrentTests
{
    [TestFixture]
    public class QBittorrentFixture : DownloadClientFixtureBase<QBittorrent>
    {
        ...
        {
            var httpHeader = new HttpHeader();
            httpHeader["Location"] = "http://test.playarr.tv/not-a-real-torrent.torrent";
        ...
        public void Download_should_refuse_magnet_if_no_trackers_provided_and_dht_is_disabled()
        {
            ...
            var remoteRom = CreateRemoteEpisode();
            remoteRom.Release.DownloadUrl = "magnet:?xt=urn:btih:ZPBPA2P6ROZPKRHK44D5OW6NHXU5Z6KR";
        ...
        public void Download_should_accept_magnet_if_trackers_provided_and_dht_is_disabled()
        {
            ...
            var remoteRom = CreateRemoteEpisode();
            remoteRom.Release.DownloadUrl = "magnet:?xt=urn:btih:ZPBPA2P6ROZPKRHK44D5OW6NHXU5Z6KR&tr=udp://abc";

            Assert.DoesNotThrowAsync(async () => await Subject.Download(remoteRom, CreateIndexer()));
        ...
        {
            const string category = "tv-playarr";
            GivenGlobalSeedLimits(1.0f);
