...
using Playarr.Core.Download.Clients.Transmission;
using Playarr.Core.Download.Clients.Vuze;
using Playarr.Core.Test.Download.DownloadClientTests.TransmissionTests;

namespace Playarr.Core.Test.Download.DownloadClientTests.VuzeTests
{
    [TestFixture]
    public class VuzeFixture : TransmissionFixtureBase<Vuze>
    {
        ...
        public async Task Download_should_return_unique_id()
        {
            ...
            var id = await Subject.Download(remoteRom, CreateIndexer());
        ...
        public async Task Download_with_GameDirectory_should_force_directory()
        {
            ...
            Mocker.GetMock<ITransmissionProxy>()
                .Verify(v => v.AddTorrentFromData(It.IsAny<byte[]>(), @"C:/Downloads/Finished/playarr", It.IsAny<TransmissionSettings>()), Times.Once());
        }
        ...
        public async Task Download_with_category_should_force_directory()
        {
            ...
            Mocker.GetMock<ITransmissionProxy>()
                  .Verify(v => v.AddTorrentFromData(It.IsAny<byte[]>(), @"C:/Downloads/Finished/transmission/playarr", It.IsAny<TransmissionSettings>()), Times.Once());
        }
        ...
        [Test]
        public async Task Download_without_GameDirectory_and_Category_should_use_default()
        {
            GivenSuccessfulDownload();
        ...
        public async Task Download_should_get_hash_from_magnet_url(string magnetUrl, string expectedHash)
        {
            ...
            var remoteRom = CreateRemoteEpisode();
            remoteRom.Release.DownloadUrl = magnetUrl;
        ...
        public void should_exclude_items_not_in_category()
        {
            ...
            _downloading.DownloadDir = @"C:/Downloads/Finished/transmission/playarr";
        ...
        [Test]
        public void should_exclude_items_not_in_GameDirectory()
        {
            GivenGameDirectory();

            _downloading.DownloadDir = @"C:/Downloads/Finished/playarr/subdir";
