...
using Playarr.Core.Download.Clients.FreeboxDownload;
using Playarr.Core.Download.Clients.FreeboxDownload.Responses;
using Playarr.Core.Parser.Model;

namespace Playarr.Core.Test.Download.DownloadClientTests.FreeboxDownloadTests
{
    [TestFixture]
    public class TorrentFreeboxDownloadFixture : DownloadClientFixtureBase<TorrentFreeboxDownload>
    {
        ...
        protected override RemoteEpisode CreateRemoteEpisode()
        {
            ...
            rom.Release.DownloadUrl = _downloadURL;
        ...
        public async Task Download_should_define_seed_ratio_as_expected(double? providerSeedRatio, double? expectedSeedRatio)
        {
            ...
            remoteRom.SeedConfiguration = new TorrentSeedConfiguration();
            remoteRom.SeedConfiguration.Ratio = providerSeedRatio;
