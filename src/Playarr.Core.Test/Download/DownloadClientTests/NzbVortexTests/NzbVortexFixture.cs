...
using Playarr.Core.Download.Clients.Nzbget;
using Playarr.Core.Download.Clients.NzbVortex;
using Playarr.Core.Download.Clients.NzbVortex.Responses;
using Playarr.Core.RemotePathMappings;
using Playarr.Test.Common;

namespace Playarr.Core.Test.Download.DownloadClientTests.NzbVortexTests
{
    [TestFixture]
    public class NzbVortexFixture : DownloadClientFixtureBase<NzbVortex>
    {
        ...
        public void Download_should_throw_if_failed()
        {
            ...
            Assert.ThrowsAsync<DownloadClientException>(async () => await Subject.Download(remoteRom, CreateIndexer()));
        }
        ...
        public void should_test_api_version(string version, bool expected)
        {
            Mocker.GetMock<INzbVortexProxy>()
                ...
                .Returns(new List<NzbVortexGroup> { new NzbVortexGroup { GroupName = ((NzbVortexSettings)Subject.Definition.Settings).GameCategory } });
