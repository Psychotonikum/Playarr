...
using Playarr.Core.ImportLists.ImportListItems;
using Playarr.Core.MetadataSource;
using Playarr.Core.Parser.Model;
using Playarr.Core.Test.Framework;

namespace Playarr.Core.Test.ImportListTests
{
    [TestFixture]
    public class FetchAndParseImportListServiceFixture : CoreTest<FetchAndParseImportListService>
    {
        ...
        public void Setup()
        {
            ...
            Mocker.GetMock<ISearchForNewSeries>()
                ...
                .Returns((string value) => new List<Games.Game>() { new Games.Game() { ImdbId = value } });
        }
        ...
        {
            var fetchResult = new ImportListFetchResult { Game = _listSeries, AnyFailure = true };
        ...
        {
            var fetchResult1 = new ImportListFetchResult { Game = _listSeries, AnyFailure = true };
            WithList(1, true, true, fetchResult1);
            var fetchResult2 = new ImportListFetchResult { Game = _listSeries, AnyFailure = false };
        ...
        public void should_return_early_if_no_available_lists()
        {
            ...
            listResult.Game.Count.Should().Be(0);
        ...
        {
            var listId = 1;
            var fetchResult = new ImportListFetchResult { Game = _listSeries, AnyFailure = false };
        ...
        {
            var passedListId = 1;
            var fetchResult1 = new ImportListFetchResult { Game = _listSeries, AnyFailure = false };
            WithList(passedListId, true, true, fetchResult1);
            var failedListId = 2;
            var fetchResult2 = new ImportListFetchResult { Game = _listSeries, AnyFailure = true };
        ...
        public void should_return_all_results_for_all_lists()
        {
            ...
            var listResult = Subject.Fetch();
            listResult.AnyFailure.Should().BeFalse();
            listResult.Game.Count.Should().Be(5);
        }
