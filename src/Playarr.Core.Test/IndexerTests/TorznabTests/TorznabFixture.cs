...
using Playarr.Core.Indexers.Torznab;
using Playarr.Core.Parser.Model;
using Playarr.Core.Test.Framework;
using Playarr.Core.Validation;

namespace Playarr.Core.Test.IndexerTests.TorznabTests
{
    [TestFixture]
    public class TorznabFixture : CoreTest<Torznab>
    {
        ...
        public async Task should_parse_recent_feed_from_torznab_tpb()
        {
            ...
            releaseInfo.Title.Should().Be("Game Title S05E02 HDTV x264-Xclusive [eztv]");
            releaseInfo.DownloadProtocol.Should().Be(DownloadProtocol.Torrent);
