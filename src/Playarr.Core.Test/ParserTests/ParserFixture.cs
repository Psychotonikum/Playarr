...
namespace Playarr.Core.Test.ParserTests
{
    ...
    {
        [TestCase("Game Title - 4x05 - Title", "seriestitle")]
        [TestCase("Game & Title - 4x05 - Title", "seriestitle")]
        [TestCase("Bad Format", "badformat")]
        [TestCase("Mad Game - Platform 1 [Bluray720p]", "madseries")]
        [TestCase("Mad Game - Platform 1 [Bluray1080p]", "madseries")]
        [TestCase("The Daily Game -", "thedailyseries")]
        [TestCase("The Game Bros. (2006)", "theseriesbros2006")]
        [TestCase("Game (2011)", "series2011")]
        [TestCase("Game Time S02 720p HDTV x264 CRON", "seriestime")]
        [TestCase("Game Title 0", "seriestitle0")]
        [TestCase("Game of the Day", "seriesday")]
        [TestCase("Game of the Day 2", "seriesday2")]
        ...
        [TestCase("Game.S03E14.720p.HDTV.X264-DIMENSION", "Game")]
        [TestCase("Game-S03E14-720p-HDTV-X264-DIMENSION", "Game")]
        [TestCase("Series_S03E14_720p_HDTV_X264-DIMENSION", "Game")]
        [TestCase("Game 2022 S03E14 720p HDTV X264-DIMENSION", "Game", 2022)]
        [TestCase("Game (2022) S03E14 720p HDTV X264-DIMENSION", "Game", 2022)]
        [TestCase("Game.2022.S03E14.720p.HDTV.X264-DIMENSION", "Game", 2022)]
        [TestCase("Game-2022-S03E14-720p-HDTV-X264-DIMENSION", "Game", 2022)]
        [TestCase("Series_2022_S03E14_720p_HDTV_X264-DIMENSION", "Game", 2022)]
