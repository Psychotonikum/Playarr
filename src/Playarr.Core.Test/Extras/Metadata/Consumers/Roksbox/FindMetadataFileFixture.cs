...
using Playarr.Core.Extras.Metadata.Consumers.Roksbox;
using Playarr.Core.Test.Framework;
using Playarr.Core.Games;
using Playarr.Test.Common;

namespace Playarr.Core.Test.Extras.Metadata.Consumers.Roksbox
{
    [TestFixture]
    public class FindMetadataFileFixture : CoreTest<RoksboxMetadata>
    {
        ...
        {
            var path = Path.Combine(_series.Path, "the.game.s01e01.rom-thumb.jpg");
