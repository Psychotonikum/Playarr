...
namespace Playarr.Core.Test.MediaFiles
{
    ...
    public class DownloadedEpisodesImportServiceFixture : CoreTest<DownloadedEpisodesImportService>
    {
        ...
        private void GivenSuccessfulImport()
        {
            ...
            imported.Add(new ImportDecision(localRom));

            Mocker.GetMock<IMakeImportDecision>()
                  .Setup(s => s.GetImportDecisions(It.IsAny<List<string>>(), It.IsAny<Game>(), It.IsAny<DownloadClientItem>(), It.IsAny<ParsedRomInfo>(), null, true, true))
                  .Returns(imported);
        ...
        public void should_delete_folder_if_files_were_imported_and_only_sample_files_remain()
        {
            ...
            Mocker.GetMock<IDetectSample>()
                  .Setup(s => s.IsSample(It.IsAny<Game>(),
                      It.IsAny<string>(),
                      It.IsAny<bool>()))
        ...
        public void should_use_folder_if_folder_import()
        {
            ...
            var fileName = @"C:\media\ba09030e-1234-1234-1234-123456789abc\[HorribleSubs] Maria the Virgin Witch - 09 [720p]\[HorribleSubs] Maria the Virgin Witch - 09 [720p].nsp".AsOsAgnostic();
            ...
            Mocker.GetMock<IMakeImportDecision>()
                  .Verify(s => s.GetImportDecisions(It.IsAny<List<string>>(), It.IsAny<Game>(), It.IsAny<DownloadClientItem>(), It.IsAny<ParsedRomInfo>(), It.Is<ParsedRomInfo>(v => v.AbsoluteRomNumbers.First() == 9), true), Times.Once());
        }
        ...
        public void should_not_use_folder_if_file_import()
        {
            ...
            var fileName = @"C:\media\ba09030e-1234-1234-1234-123456789abc\Torrents\[HorribleSubs] Maria the Virgin Witch - 09 [720p].nsp".AsOsAgnostic();
            ...
            Mocker.GetMock<IMakeImportDecision>()
                  .Verify(s => s.GetImportDecisions(It.IsAny<List<string>>(), It.IsAny<Game>(), It.IsAny<DownloadClientItem>(), It.IsAny<ParsedRomInfo>(), null, true), Times.Once());
        }
        ...
        public void should_return_rejection_if_nothing_imported_and_contains_rar_file()
        {
            ...
            var path = @"C:\Test\Unsorted\Game.Title.S01E01.abc-Playarr".AsOsAgnostic();
            var imported = new List<ImportDecision>();
        ...
        public void should_reject_if_download_is_multi_season()
        {
            ...
            _trackedDownload.DownloadItem.Title = "Game Title S01-S11";
