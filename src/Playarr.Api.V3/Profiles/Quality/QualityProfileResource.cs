...
namespace Playarr.Api.V3.Profiles.Quality
{
    ...
    {
        public string Name { get; set; }
        public Playarr.Core.Qualities.Quality Quality { get; set; }
        public List<QualityProfileQualityItemResource> Items { get; set; }
    ...
    public static class ProfileResourceMapper
    {
        ...
        public static QualityProfileQualityItem ToModel(this QualityProfileQualityItemResource resource)
        {
            ...
            return new QualityProfileQualityItem
            {
                Id = resource.Id,
                Name = resource.Name,
                Quality = resource.Quality != null ? (Playarr.Core.Qualities.Quality)resource.Quality.Id : null,
                Items = resource.Items.ConvertAll(ToModel),
