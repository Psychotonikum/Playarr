...
namespace Playarr.Api.V3.Queue
{
    ...
    {
        public static QueueResource ToResource(this Playarr.Core.Queue.Queue model, bool includeSeries, bool includeEpisode)
        {
            if (model == null)
            {
                return null;
            ...
            return new QueueResource
            {
                ...
                EpisodeHasFile = model.Rom?.HasFile ?? false,
