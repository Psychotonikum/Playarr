...
namespace Playarr.Integration.Test.ApiTests
{
    ...
    public class NamingConfigFixture : IntegrationTest
    {
        ...
        public void should_be_able_to_update()
        {
            ...
            config.StandardEpisodeFormat = "{Game Title} - {platform}x{rom:00} - {Rom Title}";
            config.DailyEpisodeFormat = "{Game Title} - {Air-Date} - {Rom Title}";
            config.AnimeEpisodeFormat = "{Game Title} - {platform}x{rom:00} - {Rom Title}";
        ...
        public void should_get_bad_request_if_standard_format_doesnt_contain_season_and_episode()
        {
            var config = NamingConfig.GetSingle();
            config.RenameEpisodes = true;
            config.StandardEpisodeFormat = "{platform}";
            config.DailyEpisodeFormat = "{Game Title} - {Air-Date} - {Rom Title}";
            config.AnimeEpisodeFormat = "{Game Title} - {platform}x{rom:00} - {Rom Title}";
        ...
        public void should_get_bad_request_if_daily_format_doesnt_contain_season_and_episode_or_air_date()
        {
            ...
            config.RenameEpisodes = true;
            config.StandardEpisodeFormat = "{Game Title} - {platform}x{rom:00} - {Rom Title}";
            config.DailyEpisodeFormat = "{Game Title} - {platform} - {Rom Title}";
            config.AnimeEpisodeFormat = "{Game Title} - {platform}x{rom:00} - {Rom Title}";
        ...
        public void should_get_bad_request_if_anime_format_doesnt_contain_season_and_episode_or_absolute()
        {
            ...
            config.StandardEpisodeFormat = "{Game Title} - {platform}x{rom:00} - {Rom Title}";
            config.DailyEpisodeFormat = "{Game Title} - {Air-Date} - {Rom Title}";
            config.AnimeEpisodeFormat = "{Game Title} - {platform} - {Rom Title}";
