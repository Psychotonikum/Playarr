...
using RestSharp;
using Playarr.Api.V3.Blocklist;
using Playarr.Api.V3.Config;
using Playarr.Api.V3.DownloadClient;
using Playarr.Api.V3.RomFiles;
using Playarr.Api.V3.Roms;
using Playarr.Api.V3.History;
using Playarr.Api.V3.Profiles.Quality;
using Playarr.Api.V3.RootFolders;
using Playarr.Api.V3.Game;
using Playarr.Api.V3.System.Tasks;
using Playarr.Api.V3.Tags;
...
namespace Playarr.Integration.Test
{
    ...
    public abstract class IntegrationTestBase
    {
        ...
        protected virtual void InitRestClients()
        {
            ...
            Roms = new EpisodeClient(RestClient, ApiKey);
        ...
        public RomFileResource EnsureRomFile(GameResource game, int platform, int rom, Quality quality)
        {
            ...
            if (result.RomFile == null)
            {
                ...
                Commands.PostAndWait(new RefreshSeriesCommand(new List<int> { game.Id }));
