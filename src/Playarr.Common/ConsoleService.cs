...
namespace Playarr.Common
{
    ...
    public class ConsoleService : IConsoleService
    {
        ...
        public void PrintHelp()
        {
            ...
            Console.WriteLine("                 /{0} Don't open Playarr in a browser", StartupContext.NO_BROWSER);
            Console.WriteLine("                 /{0} Start Playarr terminating any other instances", StartupContext.TERMINATE);
