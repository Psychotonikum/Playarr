...
namespace Playarr.Common.Extensions
{
    public static class PathExtensions
    {
        ...
        private const string DB = "playarr.db";
        private const string DB_RESTORE = "playarr.restore";
        private const string LOG_DB = "logs.db";
        private const string NLOG_CONFIG_FILE = "nlog.config";
        private const string UPDATE_CLIENT_EXE_NAME = "Playarr.Update";

        private static readonly string UPDATE_SANDBOX_FOLDER_NAME = "playarr_update" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_PACKAGE_FOLDER_NAME = "Playarr" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_BACKUP_FOLDER_NAME = "playarr_backup" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_BACKUP_APPDATA_FOLDER_NAME = "playarr_appdata_backup" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_CLIENT_FOLDER_NAME = "Playarr.Update" + Path.DirectorySeparatorChar;
