...
namespace Playarr.Common.EnvironmentInfo
{
    ...
    public class AppFolderInfo : IAppFolderInfo
    {
        ...
        private static readonly Logger Logger = PlayarrLogger.GetLogger(typeof(AppFolderInfo));
        ...
        public AppFolderInfo(IStartupContext startupContext)
        {
            ...
            {
                AppDataFolder = Path.Combine(Environment.GetFolderPath(_dataSpecialFolder, Environment.SpecialFolderOption.DoNotVerify), "Playarr");
                LegacyAppDataFolder = OsInfo.IsOsx
                    ? Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile, Environment.SpecialFolderOption.DoNotVerify), ".config", "Playarr")
                    : Path.Combine(Environment.GetFolderPath(_dataSpecialFolder, Environment.SpecialFolderOption.DoNotVerify), "Playarr");
            }
