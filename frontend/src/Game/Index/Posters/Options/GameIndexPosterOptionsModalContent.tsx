...
interface GameIndexPosterOptionsModalContentProps {
  onModalClose(...args: unknown[]): unknown;
}

function GameIndexPosterOptionsModalContent({
  onModalClose,
}: GameIndexPosterOptionsModalContentProps) {
  const {
    detailedProgressBar,
    size,
    showTitle,
  ...
  const onPosterOptionChange = useCallback(
    ({ name, value }: { name: string; value: unknown }) => {
      setGamePosterOptions({ [name]: value });
    },
    []
  );
        ...
        <Form>
          ...
          <FormGroup>
            ...
            <FormInputGroup
              ...
              name="showTitle"
              value={showTitle}
              helpText={translate('ShowGameTitleHelpText')}
              onChange={onPosterOptionChange}
            />
          </FormGroup>
...
export default GameIndexPosterOptionsModalContent;
