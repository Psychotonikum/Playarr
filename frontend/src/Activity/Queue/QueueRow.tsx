...
function QueueRow(props: QueueRowProps) {
  ...
  const roms = useRomsWithIds(romIds);
    ...
    <TableRow>
      ...
      {columns.map((column) => {
          ...
          return (
            <TableRowCell key={name}>
              <RomCellContent
                ...
                platformNumber={platformNumbers[0]}
                game={game}
              />
            </TableRowCell>
          );
        ...
        if (name === 'roms.title') {
          return (
            <TableRowCell key={name}>
              <RomTitleCellContent roms={roms} game={game} />
            </TableRowCell>
          );
        }
          ...
          return (
            <TableRowCell key={name}>
              <RelativeDateCell
                key={name}
                component="span"
                date={roms[0].airDateUtc}
              />
              {' - '}
              <RelativeDateCell
                key={name}
                component="span"
                date={roms[roms.length - 1].airDateUtc}
              />
            </TableRowCell>
          );
        }
