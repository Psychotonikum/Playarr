...
function InteractiveSearchRow(props: InteractiveSearchRowProps) {
  const {
    ...
    sceneMapping,
    mappedGameId,
    mappedPlatformNumber,
    mappedRomNumbers,
    mappedAbsoluteRomNumbers,
    mappedRomInfo,
    indexerFlags = 0,
    episodeRequested,
    downloadAllowed,
  ...
  return (
    <TableRow>
      ...
      <TableRowCell>
        <div className={styles.titleContent}>
          ...
          <ReleaseSceneIndicator
            ...
            platformNumber={mappedPlatformNumber}
            romNumbers={mappedRomNumbers}
            absoluteRomNumbers={mappedAbsoluteRomNumbers}
            scenePlatformNumber={platformNumber}
            sceneRomNumbers={romNumbers}
            sceneAbsoluteRomNumbers={absoluteRomNumbers}
      ...
      <TableRowCell className={styles.quality}>
        <RomQuality quality={quality} showRevision={true} />
      </TableRowCell>
