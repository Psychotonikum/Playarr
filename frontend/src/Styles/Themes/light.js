const playarrBlue = '#35c5f4';
const playarrAlternateBlue = '#2193b5';
const darkGray = '#888';
...
module.exports = {
  ...
  themeBlue: playarrBlue,
  themeAlternateBlue: playarrAlternateBlue,
  themeRed: '#c4273c',
  ...
  // Header
  pageHeaderBackgroundColor: playarrAlternateBlue,
