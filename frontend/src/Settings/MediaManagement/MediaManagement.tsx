...
const romTitleRequiredOptions: EnhancedSelectInputValue<string>[] = [
  {
    key: 'always',
    get value() {
            ...
            {showAdvancedSettings ? (
              <FieldSet legend={translate('Importing')}>
                <FormGroup
                  ...
                  size={sizes.SMALL}
                >
                  <FormLabel>{translate('RomTitleRequired')}</FormLabel>

                  <FormInputGroup
                    type={inputTypes.SELECT}
                    name="romTitleRequired"
                    helpText={translate('RomTitleRequiredHelpText')}
                    values={romTitleRequiredOptions}
                    onChange={handleInputChange}
                    {...settings.romTitleRequired}
                  />
                </FormGroup>
