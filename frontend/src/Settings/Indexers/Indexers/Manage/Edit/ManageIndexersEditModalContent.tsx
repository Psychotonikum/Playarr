...
function ManageIndexersEditModalContent(
  ...
  const save = useCallback(() => {
    ...
    if (platformSearchMaximumSingleRomAge !== null) {
      hasChanges = true;
      payload.platformSearchMaximumSingleRomAge =
        platformSearchMaximumSingleRomAge as number;
    }
  ...
  const onInputChange = useCallback(({ name, value }: InputChanged) => {
    switch (name) {
      ...
      case 'priority':
        ...
        break;
      case 'platformSearchMaximumSingleRomAge':
    ...
    <ModalContent onModalClose={onModalClose}>
      ...
      <ModalBody>
        ...
        <FormGroup>
          ...
          <FormInputGroup
            type={inputTypes.NUMBER}
            name="platformSearchMaximumSingleRomAge"
            helpText={translate('MaximumSingleEpisodeAgeHelpText')}
            value={platformSearchMaximumSingleRomAge}
            min={0}
            unit="days"
            onChange={onInputChange}
          />
