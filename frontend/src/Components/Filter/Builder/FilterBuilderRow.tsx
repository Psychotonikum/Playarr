...
import GameStatusFilterBuilderRowValue from './GameStatusFilterBuilderRowValue';
import GameTypeFilterBuilderRowValue from './GameTypeFilterBuilderRowValue';
...
function getRowValueConnector<T>(
  ...
  switch (valueType) {
    ...
    case filterBuilderValueTypes.SERIES_STATUS:
      return GameStatusFilterBuilderRowValue;

    case filterBuilderValueTypes.SERIES_TYPES:
      return GameTypeFilterBuilderRowValue;
